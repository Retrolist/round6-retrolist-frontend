...
import { ListHeader } from "../../types/List";
...
export default function ListsPage() {
  ...
  const [retrolistLists, setRetrolistLists] = useState<ListHeader[] | null>(
    null
  );
        ...
        <div>
          <div className="mb-5">
            <div className="text-2xl font-bold mb-1">
              RetroList Lists ({retrolistLists?.length ?? "..."})
            </div>
          ...
          <div className="mb-5">
            <div className="text-2xl font-bold mb-1">
              Badgeholder Lists ({agoraLists?.length ?? "..."})
            </div>
            <div className="text-sm text-[#4C4E64AD] border-b border-[#4C4E641F] pb-3">
          ...
          <div className="mb-5">
            <div className="text-2xl font-bold mb-1">
              Pairwise Lists ({pairwiseLists?.length ?? "..."})
            </div>
            <div className="text-sm text-[#4C4E64AD] border-b border-[#4C4E641F] pb-3">
              Lists created with{" "}
              <a
                href="https://pairwise.vote"
                className="underline"
                target="_blank"
              >
                Pairwise
