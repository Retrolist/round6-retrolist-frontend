...
import TotalOPProgressR6 from "../../components/analytics/TotalOPProgressR6";
import { median } from "../../utils/common";

export function AnalyticsR6() {
  const [categories, categoriesOSS, ballots, loading] = useOPDistributionR5('rpgf6');
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <div className="mt-3">
          <TotalOPProgressR6 ballots={ballots} showLegend={true} />
        </div>
      </div>
