...
const LEVELS = [10000, 20000, 40000, 60000]
...
export default function TotalOPProgressR6({ ballots, showLegend = true }: { ballots: {[projectId: string]: number}, showLegend: boolean }) {
  let count2 = 0;
  let count6 = 0;
  let count10 = 0;
  let count14 = 0;
